...
<div class="card">
  ...
  <a href="{{route('actionattack',[$debate,$argument])}}" class="btn btn-primary">Use Scheme</a>
  </div>
</div>
<div class="card">
  <div class="card-body">
    <h4 class="card-title">Expert Opinion Scheme</h4>
  </div>
</div>
<div class="card">
  <div class="card-body">
        ...
        <a href="{{route('expopattack',[$debate,$argument])}}" class="btn btn-primary">Use Scheme</a>

  </div>
  </div>
  <div class="card">
  <div class="card-body">
    <h4 class="card-title">Position To Know Scheme</h4>
    <h6 class="card-subtitle mb-2 text-muted"></h6>
  </div>
  <div class="card">
  <div class="card-body">
  <div class="alert alert-dark" role="alert">
                ...
                <a href="{{route('postoknowattack',[$debate,$argument])}}" class="btn btn-primary">Use Scheme</a>

  </div>
  </div>
  <div class="card">
  <div class="card-body">
    <h4 class="card-title">Popular Opinion Scheme</h4>
    <h6 class="card-subtitle mb-2 text-muted"></h6>
  </div>
  <div class="card">
  <div class="card-body">
  <div class="alert alert-dark" role="alert">
                ...
                <a href="{{route('popappealattack',[$debate,$argument])}}" class="btn btn-primary">Use Scheme</a>
  </div>
  </div>
